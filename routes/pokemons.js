...
const dexMapping = {
    ...
    terapagos: 1024,
    pecharunt: 1025
    // Voeg hier meer Pokémon toe als nodig
};
...
router.post('/', async (req, res) => {
    try {
        ...
        // Zoek het dexnummer van de Pokémon in de dexMapping
        const dexNumber = dexMapping[name.toLowerCase()];

        // Bepaal de imageUrl
        const defaultImageUrl = dexNumber
        ...
        // Als er geen imageUrl is opgegeven, gebruik dan de default imageUrl
        const finalImageUrl = imageUrl || defaultImageUrl;

        // Maak de Pokémon aan
        const mon = await Pokemon.create({
            name,
            typing,
            region,
            imageUrl: finalImageUrl, // Gebruik de finalImageUrl
        });
